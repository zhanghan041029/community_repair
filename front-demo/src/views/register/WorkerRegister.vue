...
const formData = reactive({
  name: '', phone: '', skill: '', username: '', password: '', confirmPwd: '', idCard: ''
})
    ...
    <el-card class="register-card">
      ...
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="技能特长" prop="skill">
          <el-input v-model="formData.skill" placeholder="如: 水电维修、管道疏通" />
        </el-form-item>
        ...
        <el-form-item label="身份证号">
          <el-input v-model="formData.idCard" placeholder="选填,用于实名认证" />
        </el-form-item>
        <el-form-item>
